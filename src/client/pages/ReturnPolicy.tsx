                ...
                <section className="w-full my-10">
                    <div className="w-full p-4 space-y-8">
                        ...
                        <p className="text-lg mb-6">
                            At <strong>ecommerce</strong>, we want to ensure you are completely satisfied with your purchase. If you are not fully happy with
                            your product, you can return or exchange it under the following conditions.
                        </p>
                        <div>
                        ...
                        <div>
                            ...
                            <ol className="list-decimal list-inside mb-6">
                                ...
                                <li>
                                    <strong>Prepare Your Item</strong>: Ensure that the item is securely packaged in its original packaging, along with all tags
                                    and accessories.
                                </li>
                                <li>
                                    <strong>Ship the Item</strong>: Use the return label provided by our team, or ship to the following address at your own
                                    cost:
                        ...
                        <div>
                            ...
                            <p className="text-lg mb-6">
                                ...
                                Approved refunds will be processed and applied to your original method of payment within
                        ...
                        <div>
                            ...
                            <p className="text-lg mb-6">
                                If you wish to exchange an item, please contact our customer service to arrange an exchange for a different size, color, or
                        ...
                        <div>
                            ...
                            <p className="text-lg mb-6">
                                For international returns, shipping fees are non-refundable, and customers are responsible for any customs or import duties
                                incurred.
                            </p>
                        </div>
                        <div>
