import termsAndcondition from "@/assets/banners/terms_and_conditions.webp";
        ...
        <>
            ...
            <Container>
                <section className="w-full my-10 space-y-5">
                    ...
                    <div className="w-full">
                        <h1 className="text-xl font-medium underline mb-2">Purchases and Payment Terms</h1>
                        <p>
                            All prices displayed on our website are in Rupee. We reserve the right to modify pricing without prior notice. Payments are due at
                            the time of purchase, and we accept the following payment methods: online/offline. In the event of a stock issue or unforeseen
                            circumstances affecting your order, we will notify you promptly and offer alternative solutions, including the option for a full
                            refund.
                        </p>
                    </div>
                    <div className="w-full">
                        <h1 className="text-xl font-medium underline mb-2">Shipping and Delivery</h1>
                        <p>
                            Orders are typically processed and shipped within 05 business days of purchase. Delivery times may vary depending on your location.
                            Once an item has been shipped, the risk of loss or damage passes to the buyer. Please ensure that your shipping information is
                            accurate to avoid delays or issues with delivery.
                        </p>
                    </div>
                    <div className="w-full">
                        <h1 className="text-xl font-medium underline mb-2">Returns and Refunds</h1>
                        <p>
                    ...
                    <div className="w-full">
                        <h1 className="text-xl font-medium underline mb-2">User Conduct</h1>
                        <p>
                            You agree to use our website and services responsibly and in compliance with applicable laws. Prohibited activities include, but are
                            not limited to, engaging in fraud, distributing malware, violating intellectual property rights, or using our services for unlawful
                            purposes. Violation of these terms may result in the suspension or termination of your account and legal action.
                        </p>
                    </div>
                    <div className="w-full">
                    ...
                    <div className="w-full">
                        <h1 className="text-xl font-medium underline mb-2">Privacy Policy</h1>
                        <p>
                            ...
                            Privacy Policy. We encourage you to read our <Link to={"/privacy-policy"}>Privacy Policy</Link> to understand how we collect, use,
                            and protect your data.
                        </p>
                    </div>
                    <div className="w-full">
                        <h1 className="text-xl font-medium underline mb-2">Termination</h1>
                        <p>
                            We reserve the right to terminate or suspend your account and access to our website at our sole discretion, with or without notice,
                            for any reason, including but not limited to violations of these Terms and Conditions. Upon termination, all provisions of these
                            terms which by their nature should survive termination will remain in effect.
                        </p>
                    </div>
                    <div className="w-full">
                        <h1 className="text-xl font-medium underline mb-2">Governing Law</h1>
                        <p>
                            These Terms and Conditions are governed by and construed in accordance with the laws of India/Telanagana. You agree to submit to the
                            exclusive jurisdiction of the courts located within India/Telanagana to resolve any legal matter arising from these terms.
                        </p>
                    </div>
                    <div className="w-full">
