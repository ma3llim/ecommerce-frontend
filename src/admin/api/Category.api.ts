...
import type { Category, CategoryTitle } from "../types/Category.types";
import type { AddCategoryFormValues, UpdateCategoryFormValues } from "../validation/categories/CategorySchema";
...
export const CategoryApi = {
    ...
    getActiveCategory: async (params: PaginationRequest) => {
        const response = await axiosInstance.get<ApiResponse<PageResponse<CategoryTitle>>>(ADMIN_ENDPOINTS.CATEGORY.GET_CATEGORY_ALL, { params });
